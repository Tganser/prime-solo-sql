...
UPDATE syntax_practice set account_balance=10 WHERE account_balance=0.00 AND transactions_attempted=0;
...
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('tessa', 'saint paul', 0, 0, 25.00);
